...
!!--------------------------windNew4bACC---------------------------!!
subroutine windNew4bACC(windDragForm,RedFacW,RedFacP,dt,npt,lon,lat,&
  coorx,coory,windLon,windLat,windR0,coriF,windWm,&
  windA,windB,pr,windTx,windTy)
use basicVars
implicit none
  ...
  !$acc data copyin(secLim, secInt, windLon, windLat)  

  !$acc parallel loop gang vector default(present) &
  !$acc   private(i, dr, tmpr2, w, sn, cs, wx, wy, cd, dirNode) &
  !$acc   private(secWei, is, dir1, dir2, secCd)
  do i=1,npt
