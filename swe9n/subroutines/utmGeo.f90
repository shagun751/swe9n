subroutine utmGeo(rlon4,rlat4,rx4,ry4,iway,UTMZone)
...
!        UTM_PROJECTION_ZONE   UTM zone (changed to UTMZone)
...
! input/output parameters
  ...
  integer, intent(in) :: iway,UTMZone
...
! employ the standard UTM scale factor 0.9996 and set the Easting Origin to 500,000.
  ...
  integer :: ILONGLAT2UTM=1,IUTM2LONGLAT=2
  ! integer :: UTM_PROJECTION_ZONE=45
  logical :: SUPPRESS_UTM_PROJECTION=.false.
